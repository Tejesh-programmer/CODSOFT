...
def plot_visualizations(data, model=None, X_test=None, y_test=None):
    ...
    plt.subplot(2, 2, 2)
    sns.barplot(x='Pclass', y='Survived', data=data, hue='Pclass', palette='viridis', legend=False)
    ...
    if model:
        ...
        sns.barplot(x=sorted_importances, y=sorted_features, hue=sorted_features, palette='rocket', legend=False)
